...
## DE ##
demethod='voom' #choose from 'voom', 'edgeR', 'DEseq2'
...
for(c in contrasts){
  deresults<-de(countsdfCPM_photo2_no20mW,c,demethod,multipletesting_method,nDEG = maxNDEG,FDR = FDR)
...
We compared the impacts on two DE algorithms: DEseq2 and limma-voom. To reproduce our results, run deAgreement.R (results will be stored in simAlign/results/n2a_asyn/deagreement and simAlign/results/n2a_asyn/deagreement_commonGene). This detects DE between two time points in our alpha-syn experiment (T2 and T7).

Two examples using DEseq2 and voom are shown below.

![DEseq2; FDR<0.05](simAlign/results/n2a_asyn/deagreement/pvalue05Batch1deseq2.jpeg){ width=70% }
![voom; FDR<0.05](simAlign/results/n2a_asyn/deagreement/pvalue05Batch1voom.jpeg){ width=70% }
...
![DEseq2; FDR<0.05](simAlign/results/n2a_asyn/deagreement_commonGene/pvalue05Batch1deseq2.jpeg){ width=70% }

![voom; FDR<0.05](simAlign/results/n2a_asyn/deagreement_commonGene/pvalue05Batch1voom.jpeg){ width=70% }
